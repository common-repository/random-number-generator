...
function random_number_generator_settings_menu() {
  ...
  if (function_exists('add_submenu_page')) {
    ...
    $random_number_generator_settings_page = add_submenu_page($random_number_generator_parent_menu,__('Rand#Gen.','random_number_generator'), __('Rand#Gen.','random_number_generator'), "edit_plugins", __FILE__, 'random_number_generator_optionsPage');
